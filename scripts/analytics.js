...
async function get_session(){
    var e="";
    e=await fetch("https://zero-network.duckdns.org/analytics/",{headers:{Accept:"application/json"},signal: AbortSignal.timeout(5000)})
    .then(e=>e.json())
    .then(data => {
...
function heartbeat(){
    ...
    if(uuid != "no-connection-to-server"){
        fetch("https://zero-network.duckdns.org/analytics/"+uuid,{method:"POST",Accept:"application/json",body:JSON.stringify(state),signal: AbortSignal.timeout(5000)})
